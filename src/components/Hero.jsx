            ...
            >
                ...
                <div>
                    <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span
                        className="text-[#915eff]">Alptekin</span></h1>
                    <p className={`${styles.heroSubText} mt-2 text-white-100`}>
                        I'm a computer engineering student specializing in web development and proficient in React,
                        Angular, ASP.NET Core, and Node.js.</p>
                </div>
            </div>
